...
return [
    ...
    'nome.required' => 'Nenhum nome informado.',
    'nome.string' => 'O nome informado não é um tipo texto.',
    'nome.alpha' => 'O nome deve conter somente letras.',
    'nome.size' => 'O nome não deve conter mais de :max caracteres.',
    'sobrenome.required' => 'Nenhum sobrenome informado.',
    'sobrenome.string' => 'O sobrenome deve ser um texto.',
    'sobrenome.alpha' => 'O sobrenome deve conter somente letras.',
